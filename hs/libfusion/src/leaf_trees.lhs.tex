...
The algebra being encoded is in this case (\textit{Tree\_ a b $\to$ b}).
...
Conversely, the Cochurch encoding is defined, again using the base functor for \tt{Tree}:
\begin{code}
