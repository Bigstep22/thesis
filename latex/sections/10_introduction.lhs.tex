...
\paragraph{Fusion}
The answer is yes*, but it comes with an asterisk attached, namely: *The functions that we are working with are folds or unfolds.
...
\begin{enumerate}
  ...
  \begin{itemize}
    ...
    \item If the mathematics and the encodings are implemented in a dependently typed language, can the transformation be proved to be correct?
  \end{itemize}
\end{enumerate}
