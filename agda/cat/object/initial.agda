...
module cat.object.initial {o ℓ e} (C : Category o ℓ e) where

open import Level
open import Relation.Binary.PropositionalEquality as ≡ using (_≡_)

open Category C
open import cat.morphism C using (Epi; _≅_)
open import cat.morphism.isoequiv C using (_≃_; ⌞_⌟)
open import cat.morphism.reasoning C
