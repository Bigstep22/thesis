...
open import cat.category hiding (_[_,_])

module cat.object.coproduct {o ℓ e} (𝒞 : Category o ℓ e) where
...
open import cat.morphism.reasoning 𝒞
open import cat.morphism 𝒞
