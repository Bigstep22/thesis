...
open import cat.category using (Category; _[_,_]; _[_≈_]; _[_∘_]; module Definitions)
open import cat.category.construction.core using (module Shorthands)
open import cat.functor.core using (Functor)
import cat.morphism as Morphism
import cat.morphism.reasoning as Reas
open import cat.morphism.isoequiv as IsoEquiv
open import cat.morphism.notation
