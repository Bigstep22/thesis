...
module cat.morphism.reasoning.iso {o ℓ e} (C : Category o ℓ e) where

open import Level
open import Function renaming (id to idᶠ; _∘_ to _∙_)

open import cat.category.groupoid using (IsGroupoid)
open import cat.morphism C
open import cat.morphism.reasoning.core C
