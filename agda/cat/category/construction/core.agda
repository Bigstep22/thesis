...
module cat.category.construction.core {o ℓ e} (𝒞 : Category o ℓ e) where

open import Level using (_⊔_)
open import Function using (flip)

open import cat.category.groupoid using (Groupoid; IsGroupoid)
open import cat.morphism 𝒞 as Morphism
open import cat.morphism.isoequiv 𝒞 as IsoEquiv
